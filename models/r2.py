...
class MonotIncF(nn.Module):
    def __init__(self, in_dim, out_dim, h_dim=1024,
                 x_0=0, x_1=1, y_0=-10, y_1=10):
...
class R2(nn.Module):
    def __init__(self, tau, h_dim=1024):
        ...
        self.mif = MonotIncF(in_dim=1, out_dim=1, h_dim=h_dim,
                             x_0=0, x_1=tau, y_0=0, y_1=20)
    ...
    def forward(self, x):
        ...
        with torch.enable_grad():
            ...
            (grad, ) = torch.autograd.grad(y.sum(),
                                     x,
                                     retain_graph=True,
